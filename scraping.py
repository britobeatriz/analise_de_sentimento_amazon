...
for i in range(45):
    url ='https://www.amazon.com.br/Como-fazer-amigos-influenciar-pessoas/product-reviews/8543108683/ref=cm_cr_getr_d_paging_btm_prev_'+str(i+1)+'?pageNumber='+str(i+1)+''
